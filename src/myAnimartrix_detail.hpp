...
class ANIMartRIX {
  ...
  public:
    ...
    */
    ...
    /*
    double mapAdjustRed = map(adjustRed, 0, 255, -125, 125);
    double mapAdjustGreen = map(adjustGreen, 0, 255, -125, 125);
    double mapAdjustBlue = map(adjustBlue, 0, 255, -125, 125);

    double mapAdjustRatiosA = map(adjustRatiosA, 0, 255, .1, 2);
    double mapAdjustRatiosB = map(adjustRatiosB, 0, 255, .1, 2);

    double mapAdjustOffsetA = map(adjustOffsetA, 0, 255, .1, 2);
    double mapAdjustOffsetB = map(adjustOffsetB, 0, 255, .1, 2);

    double mapCustomParam1 = map(customParam1, 0, 255, .1, 5);
    double mapCustomParam2 = map(customParam2, 0, 255, .1, 5);
    double mapCustomParam3 = map(customParam3, 0, 255, .1, 5);
    */
